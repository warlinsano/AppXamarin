...
{
    public class ListNacionalidadesPageViewModel : ViewModelBase
    {
        //public IList<Monkey> Monkeys { get; private set; }
        public IList<Nacionalidades> ListNacionalidades { get;  set; }


        private ObservableCollection<Nacionalidades> _Nacionalidades;

        public ListNacionalidadesPageViewModel(INavigationService navigationService) : base(navigationService)
        {
            ...
            response = ClientWebApi.GetAsync("api/Nacionalidades/").Result;
            if (response.IsSuccessStatusCode)
            {
                var Lista = response.Content.ReadAsStringAsync().Result;
                ListNacionalidades = JsonConvert.DeserializeObject<List<Nacionalidades>>(Lista);
            }
